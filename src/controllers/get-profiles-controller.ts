...
export class GetProfilesController {
  ...
  @ApiQuery({name: 'party', required: false, type: String, example: 'Partido Popular'})
  @ApiQuery({name: 'gender', required: false, type: String, enum: ['Hombre', 'Mujer']})
  @ApiQuery({name: 'charge', required: false, type: String, example: 'Alcalde'})
